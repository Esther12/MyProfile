    ...
    toggleCategories(){
        if(this.state.activeTab === 0){
            return(
                ...
                'url(https://cdn.freebiesupply.com/logos/large/2x/react-1-logo-png-transparent.png) center / cover'}}>React #1</CardTitle>
                <CardText>
